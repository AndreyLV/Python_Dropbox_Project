...
def fun():
    ...
    for i in range(13, -1, -1):
        for y in range(0, len(triangl[i])):
            if (triangl[i][y] + triangl[i+1][y]) > (triangl[i][y] + triangl[i+1][y+1]):
                summ.append(triangl[i][y] + triangl[i+1][y])
            else:
                summ.append(triangl[i][y] + triangl[i+1][y+1])
        triangl[i] = summ
        summ = []
        print(triangl[i])
